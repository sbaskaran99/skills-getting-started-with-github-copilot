...
# Activity categories: Sports, Arts, Intellectual
activities = {
    "Chess Club": {
    ...
    "Tennis Club": {
        "description": "Tennis lessons and tournaments for all skill levels",
...
def unregister_from_activity(activity_name: str, email: str):
    """Remove a student from an activity (idempotent)"""
    ...
    # If not present, still return 200 for idempotency
